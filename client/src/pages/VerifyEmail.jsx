        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-10">
          ...
          {status === 'success' && (
            <div>
              ...
              <p className="text-gray-400 mb-8">Your email has been verified. You can now sign in.</p>
              <Link to="/login"
          ...
          {status === 'error' && (
            <div>
              ...
              <p className="text-gray-400 mb-8">Invalid or expired link. Please register again.</p>
              <Link to="/register"
                className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-3 rounded-xl font-semibold transition-colors inline-block">
                Register Again
              </Link>
